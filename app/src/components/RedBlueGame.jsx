        ...
        <div className="sm:p-10 p-2">
            {(timer > 0) ? <div>
                ...
                <div className={'flex flex-col justify-center items-center h-lvh '}>
                    <PlainButton onClick={startGame} className={'text-xl md:w-auto sm:mx-0 mx-3 w-full hover:bg-emerald-600 hover:border-emerald-600 active:bg-emerald-600 active:border-emerald-600 text-slate-100'}>{started ? "RESTART" : "START"}</PlainButton>
                </div>
            }
