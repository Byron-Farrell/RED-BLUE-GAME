        ...
        <div>
            {(timer > 0) ? <div className="p-10">
                ...
                <div className={'flex gap-8 md:flex-row flex-col justify-center items-center'}>
                    <PlainButton onClick={() => handleClick(button1)} className={`${isRed1 ? 'text-red-400' : 'text-blue-400'} text-3xl md:w-auto w-full active:bg-slate-600`}>{ button1 }</PlainButton>
                    <PlainButton onClick={() => handleClick(button2)} className={`${isRed2 ? 'text-red-400' : 'text-blue-400'} text-3xl md:w-auto w-full active:bg-slate-600`}>{ button2 }</PlainButton>
                </div>
            </div> :
